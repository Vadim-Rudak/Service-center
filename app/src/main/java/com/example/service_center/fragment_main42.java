...
public class fragment_main42 extends ListFragment {
    String pagesID;
    ...
    public void onResume() {
        ...
        try {
            sqlHelper.open();
            userCursor = sqlHelper.database.rawQuery("select * from " + MyDatabaseHelper.TABLE_NAME + " where Month_number ="+pagesID+" and Day_number=2", null);
