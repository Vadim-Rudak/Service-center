...
public class fragment_main43 extends ListFragment {
    String pagesID;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_main43, container, false);
    ...
    public void onResume() {
        ...
        try {
            sqlHelper.open();
            userCursor = sqlHelper.database.rawQuery("select * from " + MyDatabaseHelper.TABLE_NAME + " where Month_number ="+pagesID+" and Day_number=3", null);
