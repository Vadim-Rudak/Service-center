...
public class fragment_main21 extends ListFragment {
    String pagesID;
    ...
    public void onResume() {
        ...
        try {
            sqlHelper.open();
            userCursor = sqlHelper.database.rawQuery("select * from " + MyDatabaseHelper.TABLE_NAME + " where Month_number ="+pagesID+" and Performance=1", null);
