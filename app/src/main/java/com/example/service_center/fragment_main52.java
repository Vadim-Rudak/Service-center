...
public class fragment_main52 extends ListFragment {
    ...
    public void onResume() {
        ...
        try {
            sqlHelper.open();
            userCursor = sqlHelper.database.rawQuery("select * from " + MyDatabaseHelper.TABLE_NAME + " where Month_number ="+pagesID+" and Payment=0", null);
